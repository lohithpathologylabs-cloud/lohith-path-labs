        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {loading ? (
                <div className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-400 bg-slate-50">Loading tests...</div>
              ) : (
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <label key={opt.value}
                    className={`flex items-center gap-3 border-2 rounded-xl p-4 cursor-pointer transition-colors ${form.collection_type === opt.value ? "border-blue-500 bg-blue-50" : "border-slate-200 hover:border-slate-300"}`}>
                    <input type="radio" name="collection_type" value={opt.value}
                      checked={form.collection_type === opt.value} onChange={handleChange} className="sr-only" />
            ...
            <div>
              ...
              <input type="date" name="preferred_date" value={form.preferred_date}
