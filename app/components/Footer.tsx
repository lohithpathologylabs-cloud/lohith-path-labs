    ...
    <footer className="bg-slate-900 text-slate-400">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <div className="text-blue-400 text-xs">Advanced Quality Testing</div>
              </div>
            </div>
            <p className="text-sm leading-relaxed mb-4 max-w-xs">
              Your trusted diagnostic partner in Medak, Hussainpur, Telangana. Accurate results, experienced staff, and convenient home collection services.
            </p>
            <div className="flex gap-3">
              <a
                href="https://wa.me/919182147180"
                target="_blank"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full flex items-center justify-center transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {["Blood Testing", "Thyroid Testing", "ECG Testing", "Allergy Testing", "Home Collection", "Online Booking"].map((s) => (
                <li key={s}>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span>Hussainpur, Medak<br />Telangana, India</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-blue-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+919182147180" className="hover:text-white transition-colors">+91 91821 47180</a>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-blue-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <p>© 2025 Lohith Advanced Quality Testing Path Labs. All rights reserved.</p>
          <p>Hussainpur, Medak, Telangana</p>
        </div>
      </div>
    </footer>
  );
